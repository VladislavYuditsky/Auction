...
public class QueryProvider {
    ...
    public static final String SELECT_LOT_BY_OWNER_ID_WITH_LIMIT_AND_OFFSET = "SELECT * FROM lot WHERE owner_id=? ORDER BY lot_id DESC LIMIT ? OFFSET ?";
    ...
    public static final String SELECT_LOTS_WITH_USER_BIDS_WITH_LIMIT_AND_OFFSET = "SELECT * FROM lot WHERE lot_id IN (SELECT lot_id FROM auction WHERE auction_id IN (SELECT auction_id FROM bid WHERE bidder_id=?)) LIMIT ? OFFSET ?";
    ...
    public static final String SELECT_ACTIVE_LOT_BY_AUCTION_TYPE_WITH_LIMIT_AND_OFFSET = "SELECT * FROM lot WHERE lot_id IN (SELECT lot_id FROM auction WHERE auction_type=? AND status='active') LIMIT ? OFFSET ?";
    ...
    public static final String SELECT_AWAITING_PAYMENT_LOTS_WITH_LIMIT_AND_OFFSET = "SELECT * FROM lot WHERE lot_id IN (SELECT lot_id FROM auction WHERE winner_id=?) LIMIT ? OFFSET ?";
    ...
    public static final String SELECT_AUCTION_BY_STATUS_WITH_LIMIT_AND_OFFSET = "SELECT * FROM auction WHERE status=? LIMIT ? OFFSET ?";
    ...
    public static final String SELECT_PAYMENT_BY_PAYER_ID_WITH_LIMIT_AND_OFFSET = "SELECT * FROM payment WHERE payer_id=? LIMIT ? OFFSET ?";
    ...
    public static final String SELECT_CREDIT_BY_BORROWER_ID_WITH_LIMIT_AND_OFFSET = "SELECT * FROM credit WHERE borrower_id=? ORDER BY credit_id DESC LIMIT ? OFFSET ?";
