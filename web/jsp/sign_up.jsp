...
<div class="container mt-3">
    <form id="form" method="post" action="${pageContext.request.contextPath}/create_user">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="login" id="login" value="${requestScope.login}" class="form-control" required
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="password" name="confPassword" id="confPassword" value="${requestScope.password}"
                       class="form-control" required
                       onchange="document.getElementById('passwordsNotMatch').style.display='none'"/>
                <div id="passwordsNotMatch" style="display: none" class="invalid-feedback"><fmt:message
                        key="message.passwords_not_match" bundle="${pc}"/></div>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">
...
<script>
    <jsp:directive.include file="/js/signUpDataValidator.js"/>
</script>
