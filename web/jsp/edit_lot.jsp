...
<div class="container mt-3">
    <form method="post" action="${pageContext.request.contextPath}/update_lot?lotId=${lot.id}">
        ...
        <div class="form-group row">
            ...
            <label class="col-sm-6">
                <input type="text" name="description" class="form-control" value="${lot.description}" required/>
            </label>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">
            ...
            <label class="col-sm-6">
                <input type="text" name="location" class="form-control" value="${lot.location}" required/>
            </label>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">
            ...
            <label class="col-sm-6">
                <input type="text" name="startPrice" class="form-control" value="${lot.startPrice}" required/>
            </label>
        </div>
